...
See https://github.com/akkadotnet/akkadotnet-templates/blob/dev/docs/QuantGrid.md for complete and current documentation on this template.

## Key HTTP Routes

* https://localhost:{ASP_NET_PORT}/index.html - Swagger endpoint for testing out Akka.NET-powered APIs
